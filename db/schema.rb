...
ActiveRecord::Schema[7.1].define(version: 2024_08_16_113214) do
  ...
  create_table "games", id: :string, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "deck_card_count", default: 60
    t.boolean "exact_count", default: false
  end
  ...
  create_table "lists", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.boolean "active", default: false
    t.index ["deck_id", "active"], name: "index_lists_on_deck_id_and_active", unique: true, where: "(active IS TRUE)"
